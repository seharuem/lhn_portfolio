import{u as g,r as c,d as l,m as b,j as e,M as B,n as C,f as T,l as E,c as R}from"./vendor-CN2et5C7.js";import{g as x,S as L,a as N,G as M}from"./gsap-ComQbEoo.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const m of r.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&s(m)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();x.registerPlugin(L);function I(t){const i=g({minWidth:896}),o=g({minWidth:768,maxWidth:895}),s=g({maxWidth:767}),a=c.useCallback((r,m)=>{x.to(window,{scrollTo:r,duration:.3,ease:"power2.out",onComplete:m})},[]);c.useEffect(()=>{if(s)return;let r=!1;const m=u=>{const p=window.scrollY,h=window.innerHeight,n=u.deltaY>0?1:-1;let d=9;o&&(d=1);const f=h*d;if(i&&p<h&&n===1){u.preventDefault();return}if(p<=f){if(p>=f&&n===1||p<=0&&n===-1||(u.preventDefault(),r))return;r=!0;const z=Math.round(p/h)+n,S=Math.max(0,Math.min(f,z*h));a(S,()=>{setTimeout(()=>{r=!1},50)});return}if(n===-1&&p>f-h){if(u.preventDefault(),r)return;r=!0,a(f,()=>{r=!1});return}};return window.addEventListener("wheel",m,{passive:!1}),()=>window.removeEventListener("wheel",m)},[o,i,s,a])}const w=(t=!0)=>{const i=x.timeline({defaults:{duration:.2}}),o=t?"x":"y",s=t?"xPercent":"yPercent";return i.to(".click",{opacity:0}).from(".circle",{opacity:0},"<").from("#name1",{[s]:100,[o]:"1.25rem"},"<").from("#name3",{[s]:-100,[o]:"-1.25rem"},"<").to(".name",{boxShadow:"0 0 5px var(--main)"},"<").fromTo(".scroll",{opacity:0,yPercent:-100},{opacity:1,yPercent:0},"<").set(".click",{pointerEvents:"none"},"<0.01").from(".lt",{xPercent:100,yPercent:100,opacity:0}).from(".rt",{xPercent:-100,yPercent:100,opacity:0},"<").from(".lb",{xPercent:100,yPercent:-100,opacity:0},"<").from(".rb",{xPercent:-100,yPercent:-100,opacity:0},"<").fromTo("#textBox",{right:"50%",bottom:"50%",xPercent:50,yPercent:50},{right:"6rem",bottom:"6rem",xPercent:0,yPercent:0},"<").from("#hello",{clipPath:"inset(0 100% 0 0)",opacity:0}).from(".text1",{clipPath:"inset(100% 0 0)",opacity:0},"<").from(".text2",{clipPath:"inset(0 0 100%)",opacity:0},"<").fromTo(".name",{color:"transparent"},{color:"var(--main)"}).fromTo(".circle",{scale:.1},{scale:1,rotate:"360deg"},"<").from(".door",{clipPath:"inset(50% 0)"}).to(".scroll",{opacity:0,yPercent:50},"<").to(".c1",{top:0,yPercent:0},"<").to(".c2",{top:"initial",bottom:0,yPercent:0},"<").to(".c1",{top:"50%",yPercent:-50}).to(".c2",{bottom:"50%",yPercent:50},"<").to(".cl",{rotate:90}).to(".circle",{background:"var(--mainGD)"}).to(".lt",{clipPath:"inset(0 100% 100% 0)"}).to(".rt",{clipPath:"inset(0 0 100% 100%)"},"<").to(".lb",{clipPath:"inset(100% 100% 0 0)"},"<").to(".rb",{clipPath:"inset(100% 0 0 100%)"},"<").to(["#hello","#textBox"],{opacity:0},"<").to("#hello",{clipPath:"inset(0 100% 0 0)"},"<").to("#textBox > div",{clipPath:"inset(0 0 0 100%)"},"<").to(".door",{width:"100%"},"<").to(".circleLine",{width:"100%"},"<").to(".skip",{clipPath:"inset(0 0 0 100%)"},"<").to(".door",{borderColor:"transparent",duration:.1},"<0.1").to(".circle",{opacity:0,duration:.1},"<").fromTo(".page",{scale:0},{opacity:1,scale:1,duration:.1},"<"),i};x.registerPlugin(N);const D=t=>{const i=c.useRef(null),o=c.useRef(!1),s=c.useRef(null),a=(n,d="900%")=>{i.current?.kill(),i.current=N.create({trigger:t.current,end:`+=${d}`,scrub:1,pin:!0,invalidateOnRefresh:!0,fastScrollEnd:!0,animation:n()}),window.scrollTo(0,0),x.to(t.current,{opacity:1})},r=()=>{s.current&&s.current.revert(),s.current=x.matchMedia();let n=s.current;n.add("(min-width: 1152px)",()=>a(()=>w(!0))),n.add("(min-width: 896px) and (max-width: 1151px)",()=>a(()=>w(!1)))};c.useEffect(()=>{const n=()=>{o.current&&t.current&&r()},d=()=>{n(),o.current||setTimeout(d,100)};return d(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n),s.current?.revert(),i.current?.kill()}},[r,t]);const m=(n,d)=>{i.current?.animation.progress(n),window.scrollTo({top:d})};return{skip:()=>m(1,window.innerHeight*9),top:()=>m(0,0),setReady:()=>{o.current=!0}}},P=l.div.attrs({className:"box size-29 border-solid border-(--main)"})`
...
`,ie="/lhn_portfolio/react.svg",ae="/lhn_portfolio/vite.svg",re=[{title:"Development",list:[{name:"html5",icon:"html5-plain colored"},{name:"css3",icon:"css3-plain colored"},{name:"javascript",icon:"javascript-plain colored"}]},{title:"Libraries",list:[{name:"tailwindcss",icon:"tailwindcss-original colored"},{name:"styled components",icon:"styledcomponents-plain colored"},{name:"zustand",icon:"zustand-plain"}]},{title:"Design & Collaboration",list:[{name:"photoshop",icon:"photoshop-plain"},{name:"figma",icon:"figma-plain"},{name:"gitHub",icon:"github-original"}]}];function se(){return e.jsx("div",{className:"flex-1 min-w-0 h-full flex flex-col gap-10",children:re.map(t=>e.jsxs("div",{className:"flex flex-col gap-8 w-full font-(family-name:--font2)",children:[e.jsx(k,{className:"w-max",children:t.title}),e.jsxs(X,{children:[t.list.map(i=>e.jsxs("li",{className:"flex flex-col items-center gap-2 w-20",children:[e.jsx("i",{className:`devicon-${i.icon} text-3xl`}),i.name]},i.name)),t.title==="Development"&&e.jsxs("li",{className:"flex flex-col gap-2 items-center",children:[e.jsxs("div",{className:"flex gap-4 w-max",children:[e.jsx("img",{className:"h-7.5",src:ae,alt:"vite"}),e.jsx("img",{className:"h-7.5",src:ie,alt:"react"})]}),"vite + react"]}),t.title==="Libraries"&&e.jsxs("li",{className:"flex flex-col gap-2 items-center",children:[e.jsx("img",{className:"h-7.5",src:M,alt:"gsap"}),"gsap"]})]})]},t.title))})}const oe="/lhn_portfolio/assets/animal-CMx3n4W0.jpg",ne="/lhn_portfolio/assets/limbus-BUPuvcmi.png",le="/lhn_portfolio/assets/mini-BPZNSBot.png",ce="/lhn_portfolio/assets/adot-DCGA472D.png",me="/lhn_portfolio/assets/andaz-ubZGsGC1.webp",de="/lhn_portfolio/assets/lulu-DimcYDD2.jpeg",pe=[{title:"랭킹동숲",img:oe,tag:["토이 프로젝트","반응형"],link:[{name:"home",href:"https://animal-guide.pages.dev"},{name:"figma",href:"https://www.figma.com/design/KLuZWmyOk4Dutb5gI4cOJB/랭킹동숲?node-id=687-756&p=f"},{name:"github",href:"https://github.com/webAnimalRank/animal_guide.git"}]},{title:"BMW MINI",img:le,tag:["리디자인","PC"],link:[{name:"home",href:"https://seharuem.github.io/BMW_MINI/"},{name:"figma",href:"https://www.figma.com/proto/Qz7D30J5pMv3PZsKbtPk6d/3%EC%A1%B0-mini?node-id=7-435&page-id=0%3A1&t=6w037e9EwKKBktxM-1"},{name:"github",href:"https://github.com/seharuem/BMW_MINI.git"}]}],he=[{title:"에이닷",img:ce,tag:["리디자인","PC"],link:[{name:"home",href:"https://seharuem.github.io/adot/index.html"},{name:"figma",href:"https://www.figma.com/design/n353XsyfBNgmRCfyrxBsjf/adot-%EC%8B%9C%EC%95%88?node-id=0-1&t=nBnU4P9uip48cnE7-1"},{name:"github",href:"https://github.com/seharuem/adot.git"}]},{title:"안다즈",img:me,tag:["리디자인","PC"],link:[{name:"home",href:"https://seharuem.github.io/andaz/"},{name:"figma",href:"https://www.figma.com/design/utr1xWuOPrHbA1THq38inx/Untitled?node-id=1-2&t=A9G8LSuXdAWzIwdd-1"},{name:"github",href:"https://github.com/seharuem/andaz.git"}]},{title:"룰루레몬",img:de,tag:["리디자인","PC"],link:[{name:"home",href:"https://seharuem.github.io/lululemon/"},{name:"figma",href:"https://www.figma.com/design/b5EzsoZuStZcrPZ40VpV2z/lululemon-%EC%8B%9C%EC%95%88?node-id=2-2&t=WOBsVWUf7MS0iPID-1"},{name:"github",href:"https://github.com/seharuem/lululemon.git"}]},{title:"림버스 서포트패시브",img:ne,tag:["게임 정보","반응형"],link:[{name:"home",href:"http://limbus-sp.kro.kr"},{name:"github",href:"https://github.com/seharuem/limbusSP2.git"}]}],xe=[{title:"Team",data:pe},{title:"Solo",data:he}];function ue(){return e.jsx("div",{className:"flex-1 min-w-0 flex flex-col gap-8",children:xe.map(t=>e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx(k,{children:t.title}),e.jsx("div",{className:"card grid grid-cols-[repeat(auto-fill,minmax(240px,1fr))] gap-4",children:t.data.map(i=>e.jsxs(Q,{children:[e.jsx("img",{src:i.img,className:"absolute size-full object-cover",alt:""}),e.jsxs("div",{className:"absolute inset-0 flex flex-col",children:[e.jsxs("div",{className:"flex flex-col gap-2 p-5 bg-(--bg)/70",children:[e.jsx("h3",{className:"text-2xl text-left",children:i.title}),e.jsx("div",{className:"flex gap-2 flex-wrap",children:i.tag.map((o,s)=>e.jsx(ee,{children:o},s))})]}),e.jsx("div",{className:"flex gap-1 justify-end mt-auto p-2",children:i.link.map((o,s)=>e.jsx(te,{target:"_blank",rel:"noopener noreferrer",href:o.href,className:o.name,children:o.name},s))})]})]},i.title))})]},t.title))})}function fe(){return e.jsxs(J,{children:[e.jsxs("div",{className:"flex justify-between w-full max-lg:flex-col gap-8",children:[e.jsx(j,{children:"SKILLS"}),e.jsx(se,{})]}),e.jsxs("div",{className:"flex justify-between w-full max-lg:flex-col gap-8",children:[e.jsx(j,{children:"PROJECTS"}),e.jsx(ue,{})]}),e.jsx("footer",{className:"text-sm text-(--main) opacity-50 font-semibold text-left",children:"© 2026 이하늘 포트폴리오"})]})}function ge({onReady:t}){const[i,o]=c.useState(!1);c.useEffect(()=>{C(async r=>{await E(r)}).then(()=>o(!0))},[]);const s=c.useMemo(()=>({background:{color:{value:"#020014"}},fpsLimit:30,particles:{color:{value:"#ffffff"},move:{enable:!0,speed:.2},number:{density:{enable:!0},value:80},opacity:{value:{min:.2,max:.5}},shape:{type:"circle"},size:{value:{min:1,max:3}}},detectRetina:!1}),[]),a=()=>t();return i?e.jsx(T,{id:"tsparticles",particlesLoaded:a,options:s,className:"fixed inset-0 -z-1"}):null}function be({ref:t,onClick:i}){const[o,s]=c.useState(!1);return c.useEffect(()=>{const a=new IntersectionObserver(([r])=>{s(!r.isIntersecting)},{threshold:0,rootMargin:"0px 0px -500px 0px"});return t.current&&a.observe(t.current),()=>a.disconnect()},[t]),e.jsx(G,{onClick:i,className:o?"visible":"",children:"TOP"})}function we(){const[t,i]=c.useState(!1),o=c.useRef(null),s=c.useRef(null),{skip:a,top:r,setReady:m}=D(o);return I(),e.jsxs(e.Fragment,{children:[e.jsxs(F,{ref:o,className:"opacity-0",children:[e.jsx(U,{}),e.jsx(q,{ref:s,onClick:a,children:"SKIP"})]}),e.jsx(fe,{}),e.jsx(ge,{onReady:m}),e.jsx(be,{ref:s,onClick:r})]})}R.createRoot(document.getElementById("root")).render(e.jsx(c.StrictMode,{children:e.jsx(we,{})}));
